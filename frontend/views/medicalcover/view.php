...
$this->title = 'Imprest - '.$model->Application_No;
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h3 class="card-title">Medical Cover Claim No : <?= $model->Application_No?></h3>
                    ...
                    <div class="row">
                        <div class=" row col-md-12">
                            <div class="col-md-6">
                                ...
                                <?= '<p><span>Employee No</span> '.Html::a($model->Application_No,'#'); '</p>' ?>
