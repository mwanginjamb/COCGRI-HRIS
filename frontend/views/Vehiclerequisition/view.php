...
$this->title = 'Leave Plan - '.$model->Booking_Requisition_No;
                        ...
                        <table class="table table-bordered">
                            ...
                            foreach($model->lines as $obj):
                                ...
                                <tr>
                                    ...
                                    <td><?= !empty($obj->Booking_Duration)?$obj->Booking_Duration:'Not Set' ?></td>
                                    <td><?= !empty($obj->Booked_Status)?$obj->Booked_Status:'Not Set' ?></td>
